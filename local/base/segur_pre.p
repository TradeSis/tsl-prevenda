...
def var esqcom1         as char format "x(12)" extent 5
    initial [" Retornar ", " Inclusao ", " Exclusao ", ""].
...
procedure inclusao-manual.
    ...
    do on error undo.
        ...
        */
        ...
        run garan-ws.p (vprocod, wf-movim.precoori, wf-movim.movpc).
        ...
        find produ where produ.procod = tt-segprodu.seg-procod no-lock.
        find first btt-seg-movim where btt-seg-movim.seg-procod = produ.procod
                                   and btt-seg-movim.procod = vprocod
                                 no-lock no-error.
        if avail btt-seg-movim
        then do.
            message "Seguro para o produto ja incluido na nota".
            undo.
        end.
        ...
        then do.
            ...
            if sresp
            then do.
                run exclui-segprod (vprocod, btt-seg-movim.seg-procod).

/***
                find first wf-movim
                                  where wf-movim.wrec = btt-seg-movim.seg-wrec.
                assign
                    wf-movim.movqtm = wf-movim.movqtm - 1
                    wf-movim.movpc  = wf-movim.movpc  - tt-seg-movim.movpc.
                if wf-movim.movqtm <= 0
                then delete wf-movim.

                delete btt-seg-movim.
***/
            end.
            else undo.
        end.
