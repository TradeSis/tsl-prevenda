/* helio02082023 - INCLUIR CAMPO TEMPO DE GARANTIA NA PR� VENDA - PROCESSO 521910 */
...
/*
/* helio 09032022 - [ORQUESTRA 243179 - ESCOPO ADICIONAL] Sele��o de moeda a vista na Pr�-Venda  */

helio 09022022 - [ORQUESTRA 243179] Sele��o de moeda a vista na Pr�-Venda 
...
/* #1 TP 20985036 - [819775] Valida��o ICCID [Gabriel] - Mudar para Numerico*/
...
/*                view frame f-mensagem. */
            ...
            **/
            ...
            if prevenda = no
            then do: /**ESTE BLOCO DEMORA NO PRIMEIRA INCLUS�O**/
...
procedure p-grava-clien-matfil:
    ...
    if avail tp-clien
    then do transaction:
        find ger.clien where clien.clicod = tp-clien.clicod no-error.
        if not avail ger.clien
        then create ger.clien.
        buffer-copy tp-clien to ger.clien.
        /**
        if avail ger.clien
        then do transaction:
            ger.clien.limcrd = tp-clien.limcrd.
            ger.clien.medatr = tp-clien.medatr.
    ...
    then do transaction:
        ...
        if not avail ger.cpclien
        then create ger.cpclien.
        buffer-copy tp-cpclien to ger.cpclien.
    end.
...
procedure parametros-BLACKFRIDAY:
    ...
    assign
        pdti-black = date(08,23,2018)  /*data inicio promo��o*/
        pdtf-black = date(08,23,2018)  /*data fim promo��o*/
        vdti-black = date(08,23,2018)  /*data inicio venda*/
        vdtf-black = date(08,23,2018)  /*data fim venda*/
        valt-black = 150               /*valor minimo*/               
        vdes-black = yes               /*Aplicar desconto no pre�o*/
...
As Compras de clientes: ser�o feitas nos dias 10 e 11/07
E poder�o ser utilizadas nos dias: 13 e 14/07
*****/    
/*
    ...
    then assign
            pdti-black = date(11,23,2015) /*data inicio promo��o*/
            pdtf-black = date(11,24,2015) /*data fim promo��o*/
                    ...
                    then do:
                        ...
                        then do:
                            message "CPF não cadastrado na base de Clientes, "
                                    ...
                                    "para Funcionúrio" view-as alert-box.
                            undo.
                        end.
