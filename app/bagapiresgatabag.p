...
vsaida  = vwork + replace(pnomeapi," ","") + replace(pnomerecurso," ","") +
    ...
    vapi = "http://\{IP\}/bsweb/api/lojas/\{codigoFilial\}/bag-resgata/\{cpf\}".
...
then do:
    ...
    then do:
        ...
        for each ttitens.
            ...
            if avail produ
            then ttitens.catcod = produ.catcod.
            
            ttitens.valorTotalConvertida = (ttitens.quantidadeConvertida * ttitens.valorUnitario) - ttitens.descontoproduto. /* helio 07062023 */
            ttitens.valorLiquido = ((ttitens.quantidade * ttitens.valorUnitario) - ttitens.descontoproduto) / ttitens.quantidade. /* helio 07062023 */
