...
def new shared var vcupomb2b as int format ">>>>>>>>>9". /* helio 31012023 - cupom b2b */
    ...
    put unformatted 
        ...
        skip.
            ...
            put unformatted
                ...
                "LEBES-BAG=" + string(pidbag) format "x(250)" 
                skip.
...
then
    put unformatted
        ...
        plani.numero    format "9999999999" /* Numero_Pedido */
        fone-retirada   format "x(10)"
        nome-retirada   format "x(20)"
