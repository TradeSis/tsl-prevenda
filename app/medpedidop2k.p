/* #01082022 - chama doutor n�o identificar cliente a vista */
...
if 
   prevenda.etbcod <> setbcod          /* somente pre-vendas da filial    */ 
then return.
...
put unformatted 
    ...
    prevenda.precod        format "9999999999" /* precod_Pedido */
    ...
    if avail clien 
            and prevenda.crecod = 2 /*#01082022*/
            then ttpropostacliente.clinom else entry(1,ttpropostacliente.clinom," ") format "x(40)"      /* Nome_Cliente */

    if avail clien 
        and prevenda.crecod = 2 /*#01082022*/
        then ttpropostacliente.endereco else "" format "x(30)"  /* End_Cliente */
    if avail clien 
        and prevenda.crecod = 2 /*#01082022*/
        then ttpropostacliente.numero   else "" format "x(05)"  /* Num_End_Cliente  */
    if avail clien 
        and prevenda.crecod = 2 /*#01082022*/
        then ttpropostacliente.compl    else "" format "x(35)"  /* Compl_End_Cliente*/
    if avail clien 
        and prevenda.crecod = 2 /*#01082022*/
        then ttpropostacliente.cidade   else "" format "x(35)"   /* Cidade_End_Cliente */
    if avail clien 
        and prevenda.crecod = 2 /*#01082022*/
        then ttpropostacliente.ufecod   else "" format "xxx"     /* Estado_End_Cliente */
    
    "BRA"               format "xxx"        /* Pais_End_Cliente */
    if avail clien 
        and prevenda.crecod = 2 /*#01082022*/
        then ttpropostacliente.cep      else "" format "x(10)"     /* CEP_End_Cliente  */
    ...
    prevenda.precod        format "9999999999" /* precod_PV */
    skip.
...
then put unformatted
        ...
        "00001"         format "99999" /* precod_Pedido */
