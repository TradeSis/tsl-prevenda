...
run lemestre.p ("api-tslebes", output vctslebes).
if vctslebes = ""
then do:
    message "lojapi-tokenusuarios ERRO api-tslebes ".
    return.
end.
...
vsaida  = vwork + replace(pnomeapi," ","") + replace(pnomerecurso," ","") +
    ...
    vapi = replace(vapi,"\{IP\}",vctslebes).
...
hide message no-pause.
    message "Aguarde... executando " pnomeapi + "/" pnomerecurso "em " vctslebes.
