...
def var pnomerecurso as char    init "reversa-salvacaixa".
...
def temp-table ttsaida  no-undo serialize-name "conteudoSaida" 
    ...
    ttentrada.categoria     = string(pcatcod).
...
vsaida  = vwork + replace(pnomeapi," ","") + replace(pnomerecurso," ","") +
    ...
    vapi = "http://\{IP\}/bsweb/api/lojas/\{codigoFilial\}/reversa-salvacaixa/\{codCaixa\}".
