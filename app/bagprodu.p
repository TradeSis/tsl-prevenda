...
def var vpastarelat as char.
run lemestre.p ("pasta-relat",output vpastarelat).
def var vpastapdf as char.
run lemestre.p ("pasta-pdf",output vpastapdf).
...
varquivo = vpastarelat + "/promaneio_bag_" + string(pidbag) + ".txt".
