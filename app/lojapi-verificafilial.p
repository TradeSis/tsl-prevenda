...
def var pnomerecurso as char    init "verificafilial".
...
if vchost = ""
then do:
    message "lojapi-verificafilial ERRO api-host ".
    return.
end.
...
def var vapi as char.
    ...
    vapi = "http://\{IP\}/bsweb/api/pdv/verificaFilial/\{codigoFilial\}".
...
then do:
    ...
    then do:
        ...
        if avail ttretorno
        then do:
            pemoperacao = ttretorno.emoperacao = "true".           
        end. 
